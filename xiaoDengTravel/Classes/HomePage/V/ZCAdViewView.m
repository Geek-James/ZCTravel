...
-(void)creatadView
{
    ...
    //创建广告栏下方的按钮
    UIImageView *imageV = [[UIImageView alloc]initWithFrame:CGRectMake(0, 200, Screen_Width, 96)];
...
{
    // 判断是否实现了代理方法
    if ([self.delegate respondsToSelector:@selector(sendAdButton:)]) {
